...
const R  = () => {
  ...
  return (
    ...
    <View style={styles.p}>
      ...
      <View style={styles.sub}><Text style={styles.sub2}> Words  that  starts  with  'R' </Text>
      <Text style={styles.sub2}> are:</Text>
      </View>
      <View style={styles.word}>
      <View><Text style={styles.wordText}>Rack</Text></View>
      ...
      <View style={styles.word}>
      <View><Text style={styles.wordText}>Rich</Text></View>
