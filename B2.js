...
const B2 = () => {
  ...
  return (
    <View style={styles.page}>
      ...
      <View style={styles.sub}><Text style={styles.sub2}> Words  that  starts  with  'b' </Text>
      <Text style={styles.sub2}> are:</Text>
      </View>
      <View style={styles.word}>
      <View><Text style={styles.wordText}>brick</Text></View>
      ...
      <View style={styles.word}>
      <View><Text style={styles.wordText}>barck</Text></View>
