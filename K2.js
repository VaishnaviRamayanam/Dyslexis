...
const K2 = () => {
  ...
  return (
    <View style={styles.page}>
      ...
      <View style={styles.sub}><Text style={styles.sub2}> Words  that  starts  with  'k' </Text>
      <Text style={styles.sub2}> are:</Text>
      </View>
      <View style={styles.word}>
      <View><Text style={styles.wordText}>kilos</Text></View>
      ...
      <View style={styles.word}>
      <View><Text style={styles.wordText}>koala</Text></View>
