...
const S = () => {
  ...
  return (
    ...
    <View style={styles.p}>
      ...
      <View style={styles.sub}><Text style={styles.sub2}> Words  that  starts  with  'S' </Text>
      <Text style={styles.sub2}> are:</Text>
      </View>
      <View style={styles.word}>
      <View><Text style={styles.wordText}>Sack</Text></View>
      ...
      <View style={styles.word}>
      <View><Text style={styles.wordText}>Snack</Text></View>
