...
const D = () => {
  ...
  return (
    <View style={styles.page}>
      ...
      <View style={styles.sub}><Text style={styles.sub2}> Words  that  starts  with  'D' </Text>
      <Text style={styles.sub2}> are:</Text>
      </View>
      <View style={styles.word}>
      <View><Text style={styles.wordText}>Dawn</Text></View>
      ...
      <View style={styles.word}>
      <View><Text style={styles.wordText}>Dust</Text></View>
