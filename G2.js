...
const G2 = () => {
  ...
  return (
    <View style={styles.page}>
      ...
      <View style={styles.sub}><Text style={styles.sub2}> Words  that  starts  with  'g' </Text>
      <Text style={styles.sub2}> are:</Text>
      </View>
      <View style={styles.word}>
      <View><Text style={styles.wordText}>goat</Text></View>
      ...
      <View style={styles.word}>
      <View><Text style={styles.wordText}>grill</Text></View>
