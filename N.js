...
const N  = () => {
  ...
  return (
    <View style={styles.page}>
      ...
      <View style={styles.sub}><Text style={styles.sub2}> Words  that  starts  with  'N' </Text>
      <Text style={styles.sub2}> are:</Text>
      </View>
      <View style={styles.word}>
      <View><Text style={styles.wordText}>Net</Text></View>
      ...
      <View style={styles.word}>
      <View><Text style={styles.wordText}>Nice</Text></View>
