  ...
  return (
    <View style={styles.page}>
      ...
      <View style={styles.heading}>
        ...
        <Text style={styles.heading2}>F - J</Text>
      </View>
      <View style={styles.main}>
      <View style={styles.letter}>
      <View >
        <Text style={styles.letterText}>J</Text>
        </View>
        </View>
      ...
      <View style={styles.sub}><Text style={styles.sub2}> Words  that  starts  with  'J' </Text>
      <Text style={styles.sub2}> are:</Text>
      </View>
      <View style={styles.word}>
      <View><Text style={styles.wordText}>Jelly</Text></View>
      ...
      <View style={styles.word}>
      <View><Text style={styles.wordText}>Jug</Text></View>
