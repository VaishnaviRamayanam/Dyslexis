  ...
  return (
    <View style={styles.page}>
      ...
      <View style={styles.heading}>
        ...
        <Text style={styles.heading2}>l - o</Text>
      </View>
      ...
      <View style={styles.sub}><Text style={styles.sub2}> Words  that  starts  with  'l' </Text>
      <Text style={styles.sub2}> are:</Text>
      </View>
      <View style={styles.word}>
      <View><Text style={styles.wordText}>lock</Text></View>
      ...
      <View style={styles.word}>
      <View><Text style={styles.wordText}>lap</Text></View>
