  ...
  return (
    ...
    <View style={styles.p}>
      ...
      <View style={styles.heading}>
        ...
        <Text style={styles.heading2}>p - t</Text>
      </View>
      ...
      <View style={styles.sub}><Text style={styles.sub2}> Words  that  starts  with  'q' </Text>
      <Text style={styles.sub2}> are:</Text>
      </View>
      <View style={styles.word}>
      <View><Text style={styles.wordText}>quill</Text></View>
      ...
      <View style={styles.word}>
      <View><Text style={styles.wordText}>quarrel</Text></View>
