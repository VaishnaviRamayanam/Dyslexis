...
const I2 = () => {
  ...
  return (
    <View style={styles.page}>
      ...
      <View style={styles.sub}><Text style={styles.sub2}> Words  that  starts  with  'i' </Text>
      <Text style={styles.sub2}> are:</Text>
      </View>
      <View style={styles.word}>
      <View><Text style={styles.wordText}>ice</Text></View>
      ...
      <View style={styles.word}>
      <View><Text style={styles.wordText}>it</Text></View>
