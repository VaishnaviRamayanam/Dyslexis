...
const Quiz33 = () => {
  ...
  return (
    ...
    <View style={styles.p}>
     ...
     <TouchableOpacity
        onPress={() =>{
            navigation.navigate('Quiz33w')
        }}>
      <View style={styles.op}>
        <Text style={styles.opt}>2</Text>
     </View>
