...
const H2 = () => {
  ...
  return (
    <View style={styles.page}>
      ...
      <View style={styles.sub}><Text style={styles.sub2}> Words  that  starts  with  'h' </Text>
      <Text style={styles.sub2}> are:</Text>
      </View>
      <View style={styles.word}>
      <View><Text style={styles.wordText}>hat</Text></View>
      ...
      <View style={styles.word}>
      <View><Text style={styles.wordText}>hot</Text></View>
