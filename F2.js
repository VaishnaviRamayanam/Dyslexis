...
const F2 = () => {
  ...
  return (
    <View style={styles.page}>
      ...
      <View style={styles.sub}><Text style={styles.sub2}> Words  that  starts  with  'f' </Text>
      <Text style={styles.sub2}> are:</Text>
      </View>
      <View style={styles.word}>
      <View><Text style={styles.wordText}>fan</Text></View>
      ...
      <View style={styles.word}>
      <View><Text style={styles.wordText}>frock</Text></View>
