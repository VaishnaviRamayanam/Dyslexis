...
const C = () => {
  ...
  return (
    <View style={styles.page}>
      ...
      <View style={styles.sub}><Text style={styles.sub2}> Words  that  starts  with  'C' </Text>
      <Text style={styles.sub2}> are:</Text>
      </View>
      <View style={styles.word}>
      <View><Text style={styles.wordText}>Can</Text></View>
      ...
      <View style={styles.word}>
      <View><Text style={styles.wordText}>Cat</Text></View>
