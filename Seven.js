  ...
  return (
    ...
    <View style={styles.p}>
      ...
      <View style={styles.heading}>
        <Text style={styles.heading1}>Numbers</Text>
      </View>
      <View style={styles.main}>
      <View style={styles.letter}>
      <View >
        <Text style={styles.letterText}>Seven</Text>
        </View>
        </View>
      ...
      <View style={styles.sub}><Text style={styles.sub2}> The  number  of  lines  </Text>
      <Text style={styles.sub2}> represent  the  number</Text>
      </View>
      <View style={styles.word}>
      <View><Text style={styles.wordText}>| | | | | | |</Text></View>
