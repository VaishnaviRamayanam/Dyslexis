...
const Quiz32 = () => {
  ...
  return (
    ...
    <View style={styles.p}>
      ...
      <Text style={styles.sub2}>select  which  number  it  is</Text>
      </View>
      ...
      <TouchableOpacity
        onPress={() =>{
            navigation.navigate('Quiz32r')
        }}>
      <View style={styles.op}>
        <Text style={styles.opt}>10</Text>
     </View>
     </TouchableOpacity>
     <TouchableOpacity
        onPress={() =>{
            navigation.navigate('Quiz32w')
        }}>
      <View style={styles.op}>
        <Text style={styles.opt}>4</Text>
     </View>
