  ...
  return (
    ...
    <View style={styles.p}>
      ...
      <View style={styles.heading}>
        ...
        <Text style={styles.heading2}>u - z</Text>
      </View>
      <View style={styles.main}>
      <View style={styles.letter}>
      <View >
        <Text style={styles.letterText}>y</Text>
        </View>
        </View>
      ...
      <View style={styles.sub}><Text style={styles.sub2}> Words  that  starts  with  'y' </Text>
      <Text style={styles.sub2}> are:</Text>
      </View>
      <View style={styles.word}>
      <View><Text style={styles.wordText}>yum</Text></View>
      ...
      <View style={styles.word}>
      <View><Text style={styles.wordText}>yup</Text></View>
