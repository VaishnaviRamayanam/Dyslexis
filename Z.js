...
const Z  = () => {
  ...
  return (
    ...
    <View style={styles.p}>
      ...
      <View >
        <Text style={styles.letterText}>Z</Text>
        </View>
        </View>
      ...
      <View style={styles.sub}><Text style={styles.sub2}> Words  that  starts  with  'Z' </Text>
      <Text style={styles.sub2}> are:</Text>
      </View>
      <View style={styles.word}>
      <View><Text style={styles.wordText}>Zeal</Text></View>
      ...
      <View style={styles.word}>
      <View><Text style={styles.wordText}>Zero</Text></View>
