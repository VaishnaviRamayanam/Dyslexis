...
const P  = () => {
  ...
  return (
    <View style={styles.page}>
      ...
      <View style={styles.sub}><Text style={styles.sub2}> Words  that  starts  with  'P' </Text>
      <Text style={styles.sub2}> are:</Text>
      </View>
      <View style={styles.word}>
      <View><Text style={styles.wordText}>Pack</Text></View>
      ...
      <View style={styles.word}>
      <View><Text style={styles.wordText}>Pot</Text></View>
