...
const A = () => {
  ...
  return (
    <View style={styles.page}>
      ...
      <View style={styles.sub}><Text style={styles.sub2}> Words  that  starts  with  'A' </Text>
      <Text style={styles.sub2}> are:</Text>
      </View>
      <View style={styles.word}>
      <View><Text style={styles.wordText}>Apple</Text></View>
      ...
      <View style={styles.word}>
      <View><Text style={styles.wordText}>Atlas</Text></View>
