...
const O  = () => {
  ...
  return (
    <View style={styles.page}>
      ...
      <View style={styles.sub}><Text style={styles.sub2}> Words  that  starts  with  'O' </Text>
      <Text style={styles.sub2}> are:</Text>
      </View>
      <View style={styles.word}>
      <View><Text style={styles.wordText}>Oath</Text></View>
      ...
      <View style={styles.word}>
      <View><Text style={styles.wordText}>Oats</Text></View>
