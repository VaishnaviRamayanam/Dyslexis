...
const Quiz34 = () => {
  ...
  return (
    ...
    <View style={styles.p}>
      ...
      <TouchableOpacity
        onPress={() =>{
            navigation.navigate('Quiz34w')
        }}>
      <View style={styles.op}>
        <Text style={styles.opt}>6</Text>
     </View>
     </TouchableOpacity>
     <TouchableOpacity
        onPress={() =>{
      ...
      <View style={styles.op}>
        <Text style={styles.opt}>0</Text>
     </View>
     </TouchableOpacity><TouchableOpacity
        onPress={() =>{
            navigation.navigate('Quiz34r')
        }}>
      <View style={styles.op}>
        <Text style={styles.opt}>8</Text>
     </View>
     </TouchableOpacity><TouchableOpacity
        onPress={() =>{
            navigation.navigate('Quiz34w')
